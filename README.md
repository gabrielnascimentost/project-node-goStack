...
- Utilizar o Mailtrp para testar envios em ambiente de dev;
...
- O usuário deve poder atulizar seu nome, email e senha;
...
- O usuário deve poder realizar agendamentos com um prestador;
